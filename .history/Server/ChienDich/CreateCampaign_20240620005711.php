...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // $status = $data['status'];
     ...
     $dateStart = htmlspecialchars($data['dateStart']);
     $dateEnd = htmlspecialchars($data['dateEnd']);
    ...
    if (!$stmt->bind_param("sssssddsssssss", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $image, $description, $status)) {
