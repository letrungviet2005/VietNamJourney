...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($data['name']) || !isset($data['province']) || !isset($data['district']) || !isset($data['status']) || !isset($data['location']) || !isset($data['dateStart']) || !isset($data['dateEnd']) || !isset($data['totalMoney']) || !isset($data['moneyByVNJN']) || !isset($data['target']) || !isset($data['timeline']) || !isset($data['infoContact']) || !isset($data['infoOrga'])) {
