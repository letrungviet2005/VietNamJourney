...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssssssddsssss", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $imageData, $description, $status);
