...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    if ($imageData !== null) {
        ...
        $null = NULL;
        $stmt->bind_param("ssssssiissssii", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $null, $description, $status, $id);
