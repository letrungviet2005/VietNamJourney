...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($imageData !== null) {
        ...
        $null = NULL;
        $stmt->bind_param("ssssđ", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $null, $description, $status, $id);
