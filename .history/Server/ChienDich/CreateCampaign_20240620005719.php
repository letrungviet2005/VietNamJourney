...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$stmt->bind_param("sssssddssssss", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $image, $description, $status)) {
