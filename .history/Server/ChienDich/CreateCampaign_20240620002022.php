...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $requiredFields = ['name', 'province', 'district', 'location', 'dateStart', 'dateEnd', 'totalMoney', 'moneyByVNJN', 'target', 'timeline', 'infoContact', 'infoOrganization', 'image', 'description', 'status'];
    ...
    $stmt->bind_param("ssss", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $target, $timeline, $infoContact, $infoOrganization, $image, $description, $status); // Ràng buộc tham số với truy vấn
