...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $requiredFields = [ 'province', 'district', 'location', 'dateStart', 'dateEnd', 'totalMoney', 'moneyByVNJN', 'target', 'timeline', 'infoContact', 'infoOrganization', 'image', 'description', 'status'];
