...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $null = NULL;
    $stmt->bind_param("ssssddiisssbsi", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $null, $description, $status);
