          ...
          {userName ? (
            <div className={cx('nav-item', { open: isDropdownOpen })}>
              ...
              <div className={cx('dropdown-menu')}>
                <Link className={cx('dropdown-item')} to="/Profile" onClick={closeDropdown}>
                  Thông tin cá nhân
                </Link>
                <Link className={cx('dropdown-item')} to="/Settings" onClick={closeDropdown}>
                  Cài đặt
                </Link>
          ...
          <div className={styles['list-navbar']}>
            ...
            {userName ? (
              <div className={cx('nav-item')}>
                ...
                <div className={cx('dropdown-menu')}>
                  <Link className={cx('dropdown-item')} to="/Profile" onClick={toggleSidebar}>
                    Thông tin cá nhân
                  </Link>
