...
function Navbar() {
  const userName = useCheckCookie('User_Name', null); // Kiểm tra cookie `User_Name`
    ...
    <header className={styles.header}>
      ...
      <div className={styles.links}>
        <nav>
          ...
          <Link to="/Quy">QUỸ</Link>
          <Link to={link}>
            {userName ? userName : 'ĐĂNG NHẬP'} {/* Hiển thị tên người dùng hoặc 'ĐĂNG NHẬP' */}
          </Link>
        </nav>
      </div>
      ...
      <div className={`${styles.sidebar} ${isSidebarOpen ? styles.open : ''}`}>
        <div className={styles['sidebar-content']}>
          ...
          <div className={styles['list-navbar']}>
            ...
            <Link to={link} onClick={toggleSidebar}>
              {userName ? userName : 'ĐĂNG NHẬP'} <i className="fa-solid fa-user"></i> {/* Hiển thị tên người dùng hoặc 'ĐĂNG NHẬP' */}
            </Link>
          </div>
        </div>
      </div>
