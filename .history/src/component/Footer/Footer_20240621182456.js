...
import logo1 from '../../Images/header1.png';
import logo2 from '../../Images/header2.png';
  ...
  return (
    <footer className={cx('footer')}>
      <div className={cx('footer-container')}>
        ...
        <div className={cx('footer-section', 'footer-social')}>
          <h3>Follow Us</h3>
          <ul>
            ...
            <li><a href="#"><i className="fa-brands fa-github"></i></a>Github</li>
