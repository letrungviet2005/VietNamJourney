...
//   //       const foundProvince = provinces.find(province => province.Name === campaignData.province);
        
//   //       // Nếu tìm thấy tỉnh, tìm huyện dựa trên tên huyện
//   //       const foundDistrict = foundProvince ? foundProvince.District.find(district => district.Name === campaignData.district) : null;
...
//   //       // setSelectedProvince({
//   //       //   value: campaignData.provinceCode,
//   //       //   label: campaignData.provinceName
//   //       // });
//   //       // setSelectedDistrict({
//   //       //   value: campaignData.districtCode,
//   //       //   label: campaignData.districtName
//   //       // });
...
//     const imageData = imageFile ? await convertImageToBase64(imageFile) : campaign.image;
...
//               <input className={cx("desc")} name="timelineGiaiDoanBanDau" defaultValue={campaign.timeline?.[0]?.value} />
//               <label className={cx("inner-title")}>Bắt đầu dự án</label>
//               <input className={cx("desc")} name="timelineBatDauDuAn" defaultValue={campaign.timeline?.[1]?.value} />
//               <label className={cx("inner-title")}>Kết thúc dự án</label>
//               <input className={cx("desc")} name="timelineKetThucDuAn" defaultValue={campaign.timeline?.[2]?.value} />
//               <label className={cx("inner-title")}>Tổng kết dự án</label>
//               <input className={cx("desc")} name="timelineTongKetDuAn" defaultValue={campaign.timeline?.[3]?.value} />
//             </div>
//           </div>
...
function UpdateCampaign() {
  ...
  useEffect(() => {
    const fetchCampaign = async () => {
      try {
        ...
        setContacts(campaignData.infoContact || []);
        setOrganizationContacts(campaignData.infoOrganization || []);
        setSelectedImage(campaignData.image ? `http://localhost/bwd/VietNamJourney/Server/images/${campaignData.image}` : null);
      } catch (error) {
        console.error("Error fetching campaign data:", error);
      }
    };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.data.success) {
        alert('Cập nhật chiến dịch thành công!');
        // Redirect hoặc thực hiện các hành động khác sau khi cập nhật thành công
      } else {
        alert('Lỗi: ' + response.data.error);
      }
    } catch (error) {
  ...
  return (
    <div className={cx("UpdateCampaign")}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={cx("row")}>
          <div className={cx("col-2")}>
            <label htmlFor="image" className={cx("image")}>
              Hình ảnh chiến dịch:{" "}
            </label>
          </div>
          <div className={cx("col-10")}>
        ...
        <div className={cx("row")}>
          <div className={cx("col-2")}>
            <label htmlFor="totalMoney" className={cx("totalMoney")}>
              Tổng kinh phí (VNĐ):{" "}
            </label>
          </div>
          <div className={cx("col-10")}>
        ...
        <div className={cx("row")}>
          <div className={cx("col-2")}>
            <label htmlFor="moneyByVNJN" className={cx("moneyByVNJN")}>
              Kinh phí VNJN (VNĐ):{" "}
            </label>
          </div>
          <div className={cx("col-10")}>
            <input
              ...
              id="moneyByVNJN"
              name="moneyByVNJN"
              className={cx("input-moneyByVNJN")}
              defaultValue={campaign.moneyByVNJN}
              required
            />
          </div>
          ...
          <div key={index} className={cx("row")}>
            <div className={cx("col-5")}>
              <input
                type="text"
                placeholder="Tên tổ chức"
                className={cx("input-contactName")}
                value={contact.organizationName}
                onChange={(e) => handleNameChange(index, e)}
              />
            </div>
            <div className={cx("col-5")}>
              <input
                ...
                className={cx("input-contactEmail")}
                value={contact.contactEmail}
                onChange={(e) => handleEmailChange(index, e)}
              />
            </div>
        ...
        <button
          type="button"
          className={cx("add-contact-button")}
        ...
        <hr />
        <div className={cx("title")}>Tổ chức thực hiện </div>
        {organizationContacts.map((organization, index) => (
          <div key={index} className={cx("row")}>
            <div className={cx("col-5")}>
              <input
                type="text"
                placeholder="Tên tổ chức"
                className={cx("input-organizationName")}
                value={organization.organizationName}
                onChange={(e) => handleOrganizationNameChange(index, e)}
              />
            </div>
        ...
        <hr />
        <div className={cx("title")}>Thời gian </div>
        <div className={cx("row")}>
          <div className={cx("col-5")}>
            <label htmlFor="timelineGiaiDoanBanDau">Giai đoạn ban đầu:</label>
          </div>
          <div className={cx("col-5")}>
            <input
              type="date"
              id="timelineGiaiDoanBanDau"
              name="timelineGiaiDoanBanDau"
              className={cx("input-timeline")}
        ...
        <div className={cx("row")}>
          <div className={cx("col-5")}>
            <label htmlFor="timelineBatDauDuAn">Bắt đầu dự án:</label>
          </div>
          <div className={cx("col-5")}>
            <input
              type="date"
              id="timelineBatDauDuAn"
        ...
        <div className={cx("row")}>
          <div className={cx("col-5")}>
            <label htmlFor="timelineKetThucDuAn">Kết thúc dự án:</label>
          </div>
          <div className={cx("col-5")}>
            <input
              type="date"
              id="timelineKetThucDuAn"
        ...
        <div className={cx("row")}>
          <div className={cx("col-5")}>
            <label htmlFor="timelineTongKetDuAn">Tổng kết dự án:</label>
          </div>
          <div className={cx("col-5")}>
            <input
              type="date"
              id="timelineTongKetDuAn"
        ...
        <hr />
        <div className={cx("title")}>Địa điểm thực hiện</div>
        <div className={cx("row")}>
          <div className={cx("col-2")}>
        ...
        <hr />
        <div className={cx("title")}>Đối tượng tham gia</div>
          ...
          <div key={index} className={cx("row")}>
            <div className={cx("col-5")}>
              <input
                ...
                value={target}
                onChange={(e) => handleTargetAudienceChange(index, e)}
              />
            </div>
          </div>
        ))}
        <button
          type="button"
          className={cx("add-target-button")}
        ...
        <hr />
        <div className={cx("title")}>Thông tin khác</div>
