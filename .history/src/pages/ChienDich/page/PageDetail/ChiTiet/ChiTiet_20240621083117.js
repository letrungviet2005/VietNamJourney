...
function ChiTiet({campaign}) {
  console.log(campaign.timeline['Giai đoạn ban đầu']);
      ...
      <div className={cx("row")}>
        <div className={cx("col-6", "left")}>
          ...
          <div className={cx("time")}>
            ...
            <div className={cx("desc")}>{campaign.timeline['Giai đoạn ban đầu']}</div>
            <div className={cx("inner-title")}>Bắt đầu dự án</div>
            <div className={cx("desc")}>{campaign.timeline['Bắt đầu dự án']}</div>
            <div className={cx("inner-title")}>Kết thúc dự án</div>
            <div className={cx("desc")}>{campaign.timeline['Kết thúc dự án']}</div>
            <div className={cx("inner-title")}>Tổng kết dự án</div>
            <div className={cx("desc")}>{campaign.timeline['Tổng kết dự án']}</div>
          </div>
        </div>
