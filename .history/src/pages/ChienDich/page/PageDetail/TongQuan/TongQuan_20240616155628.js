    ...
    <div className={cx('TongQuan')}>
      ...
      <div className={cx('info')}>
        ...
        <div className={cx('button')}>
          <button className={cx('button-red')}>Bạn chưa đăng ký tham gia</button>
          <button className={cx('button-blue')}>Thông tin đang chờ duyệt</button>
          <button className={cx('button-green')}>Bạn là thành viên của chiến dịch</button>
        </div>
        <div className={cx('info-registered')}>
          <p className={cx('name')}>LÊ HỮU ANH TÚ</p>
          <p className="ban">BAN HẬU CẦN</p>
        </div>
        <div className={cx('contact')}>
          <div className={cx('title')}>Mọi thắc mắc xin liên hệ:</div>
