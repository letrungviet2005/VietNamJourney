...
function TacDong({ campaign }) {
  const totalMoney = campagin.totalMoney.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' });
  const formattedAmount = campaign.moneyByVNJN.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' });
