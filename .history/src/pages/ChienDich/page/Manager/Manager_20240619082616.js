        ...
        <table className={cx('table')}>
          <thead>
            <tr>
              ...
              <th>Tỉnh</th>
              <th>Quận/Huyện</th>
              <th className={cx('small')}>TNV tham gia</th>
              <th className={cx('small')}>TNV chờ duyệt</th>
              <th>Tình trạng</th>
            </tr>
          </thead>
          <tbody>
            {data.map(campaign => (
              <tr key={campaign.id}>
                ...
                <td className={cx('small')}>{campaign.joined}</td>
                <td className={cx('small')}>{campaign.pending}</td>
