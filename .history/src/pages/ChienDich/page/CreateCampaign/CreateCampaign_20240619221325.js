      ...
      <div className={cx('row')}>
        <div className={cx('col-4')}>
          ...
          <div className={cx("time")}>
            ...
            <input type="" className={cx("desc")}>Từ 08/07 - Kéo dài 150 ngày</input>
            <label className={cx("inner-title")}>Kết thúc dự án</label>
            <input type="" className={cx("desc")}>Từ 01/12 - Còn 34 ngày</input>
            <label className={cx("inner-title")}>Tổng kết dự án</label>
            <input type="" className={cx("desc")}>Tháng 12</input>
          </div>
        </div>
