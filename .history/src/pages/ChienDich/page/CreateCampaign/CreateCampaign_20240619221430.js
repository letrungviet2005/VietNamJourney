...
function CreateCampaign() {
  ...
  return (  
    <div className={cx('CreateCampaign')}>
      ...
      <div className={cx('row')}>
        <div className={cx('col-4')}>
          <div for="timeline" className={cx('timeline')}>Thông tin các mốc thời gian: </div>
          <div className={cx("time")}>
            <label className={cx("inner-title")}>Giai đoạn ban đầu</label>
            <input className={cx("desc")}>Từ 08/06 - Kéo dài 30 ngày</input>
            <label className={cx("inner-title")}>Bắt đầu dự án</label>
            <input className={cx("desc")}>Từ 08/07 - Kéo dài 150 ngày</input>
            <label className={cx("inner-title")}>Kết thúc dự án</label>
            <input className={cx("desc")}>Từ 01/12 - Còn 34 ngày</input>
            <label className={cx("inner-title")}>Tổng kết dự án</label>
            <input className={cx("desc")}>Tháng 12</input>
          </div>
        </div>
