...
function CreateCampaign() {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log("Date Start:", event.target.dateStart.value);
    console.log("Date End:", event.target.dateEnd.value);
    console.log("Total Money:", event.target.totalMoney.value);
    console.log("Money by VNJN:", event.target.moneyByVNJN.value);
