    ...
    <div className={cx('CreateCampaign')}>
      ...
      <div className={cx('row')}>
        <div className={cx('col-4')}>
          ...
          <input type="number" id="timeline" name="timeline" className={cx('input-timeline')} />
        </div>

        <div className={cx('col-4')}>
          <label for="location" className={cx('location')}>Quỹ VIETNAM JOURNEY tài trợ: </label>
          <input type="number" id="location" name="location" className={cx('input-location')} />
        </div>
      </div>
