...
const provinces = [
  {
    id: 'VinhPhuc',
    name: 'Vĩnh Phúc',
    d: 'M194,169.9c-0.5,0-0.8,0-1.1,0s-0.3-0.1-0.5-0.3c-0.1-0.1-0.2-0.2-0.3-0.3c-0.2-0.2-0.9-1.2-1.1-1.6c-0.1-0.2-0.2-0.8-0.2-1c0-0.1,0-0.2,0-0.3c0.2-0.3,0.3-0.8,0.3-1.4c0-0.5-0.3-0.9-0.9-1.5
