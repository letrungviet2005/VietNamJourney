...
function Contact() {
  return (  
    <div className={cx('Contact')}>
      ...
      <div className={cx('row')}>
        <div className={cx('col-3', 'chuyengia')}>
          ...
          <div className={cx('email')}>amgad.elmahdi@contact.com</div>
        </div>
        <div className={cx('col-4', 'chuyengia')}>
