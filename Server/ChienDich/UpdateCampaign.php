...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    if ($imageData !== null) {
        ...
        // Ràng buộc các tham số với truy vấn
        $stmt->bind_param("ssssssiissssii", $name, $province, $district, $location, $dateStart, $dateEnd, $totalMoney, $moneyByVNJN, $timeline, $infoContact, $infoOrganization, $description, $status, $id);
    }
