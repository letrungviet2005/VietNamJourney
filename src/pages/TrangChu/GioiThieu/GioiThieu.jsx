...
import vid1 from "../../../Images/TrangChu/GioiThieu/videonen.mp4";
        ...
        <div className={styles.main}>
            ...
            <div className={styles.top}>
                <div className={styles.txt}>
                    ...
                    <p>Với sứ mệnh nâng cao nhận thức về những thách thức môi trường mà đất nước đang phải đối mặt, từ những khu rừng nhiệt đới tươi tốt đến những rạn san hô rực rỡ. Hãy tham gia cùng chúng tôi thông qua các ​​cộng đồng, cơ hội tình nguyện và giáo dục, từ đó cùng nhau tạo nên một tương lai bền vững cho môi trường Việt Nam.</p>
                </div>
            ...
            <div className={styles.bot}>
                <div className={styles.tabs}>
                    ...
                    <div className={styles.tab}>
                        ...
                        <p className={styles.p2}>Những cá nhân<br></br>
                        phát triển dự án này</p>
                    ...
                    <div className={styles.tab}>
                        ...
                        <p className={styles.p2}>Thực trạng môi trường<br></br>
                    ...
                    <div className={styles.tab}>
                        ...
                        <p className={styles.p2}>Những hoạt động chính<br></br>
                        của dự án chúng tôi</p>
