import styles from './New1.module.css';
    ...
    return(
        <div className={styles.main}>
            <div className={styles.InDiv}>
                <h2>Việt Nam quyết tâm với cam kết đạt phát thải ròng bằng 0 vào 2050 </h2>

                <img alt="^_^" src={anh1}></img>

                <p>Trong khuôn khổ Tuần lễ Cấp cao Đại hội đồng Liên hợp quốc khóa 78 tại trụ sở Liên hợp quốc ở New York, Hoa Kỳ, sáng ngày 20/9 (giờ địa phương), Hội nghị Thượng đỉnh Tham vọng Khí hậu đã khai mạc trọng thể, với sự tham dự của đông đảo lãnh đạo cấp cao các nước và các tổ chức quốc tế. Thủ tướng Chính phủ Phạm Minh Chính đã dẫn đầu Đoàn Việt Nam tham dự Hội nghị.
                </p>
                ...
                <p>Phát biểu tại Hội nghị, Thủ tướng Chính phủ Phạm Minh Chính nhấn mạnh biến đổi khí hậu tiếp tục là thách thức toàn cầu lớn nhất, tác động trực tiếp và gây tổn thất nặng nề đối với phát triển kinh tế, an sinh xã hội và trực tiếp đối với an toàn tính mạng, sức khỏe của người dân.
                </p>

                <p>Thủ tướng cho rằng, giải quyết biến đổi khí hậu phải có cách tiếp cận toàn cầu và toàn dân, với những giải pháp đột phá, tổng thể, toàn diện, đổi mới và sáng tạo và kêu gọi cần khẩn trương hơn, hành động mạnh mẽ hơn và có trách nhiệm hơn nữa để hạn chế tối đa mức tăng nhiệt độ Trái Đất.
                </p>
